  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        ContactDetails(),
        DottedLine(context.dynamicWidth(16/412), context.dynamicWidth(16/412), 0, context.dynamicWidth(10/412)),
        AddressesInformation(),
        DottedLine(context.dynamicWidth(16/412), context.dynamicWidth(16/412), context.dynamicWidth(10/412), 0),
