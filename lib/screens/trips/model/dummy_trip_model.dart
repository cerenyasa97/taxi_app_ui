...
class DummyTrip{
  ...
  DummyTrip({this.startLocation, this.endLocation, this.date, this.startTime, this.endTime, this.tripStatus, this.distance, this.time, this.price, this.driver, this.rating, this.comments});
