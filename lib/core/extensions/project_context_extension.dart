...
extension TaxiAppContext on BuildContext {
  ...
  EdgeInsetsGeometry get homeContainerPadding =>
      EdgeInsets.only(
...
extension DividerExtension on BuildContext{
  Divider get greyThinHorizontalDivider =>
      Divider(height: 3, color: Colors.grey.shade400,);

  Widget get greyThinVerticalDivider =>
