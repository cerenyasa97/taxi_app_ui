...
class _DropDownMenuWithBorderState extends State<DropDownMenuWithBorder> {
  ...
  Widget build(BuildContext context) {
    return Container(
      padding: EdgeInsets.symmetric(horizontal: context.dynamicWidth(5/412)),
      decoration: BoxDecoration(
          border: Border.all(color: Colors.grey, width: 2),
          borderRadius: BorderRadius.circular(context.dynamicWidth(8/412))
      ),
        ...
        child: DropdownButton(
          items: widget.dropdownList
            ...
            value: e.toString(),
              ...
              .toList(),
          style: Provider.of<ProjectThemeData>(context).getThemeData.textTheme.bodyText1,
          value: currentValue,
          onChanged: (value) {
            setState(() {
              currentValue = value.toString();
